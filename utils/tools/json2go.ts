// Its a fork from https://github.com/mholt/json-to-go/blob/master/json-to-go.js
...
export function jsonToGo(json: string, typename: any, flatten = true) {
  let data;
  let scope;
  let go = '';
  let tabs = 0;
  ...
  function mostSpecificPossibleGoType(typ1: any, typ2: any) {
  ...
  function getOriginalName(unique: any) {
